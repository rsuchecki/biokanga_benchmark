#!/bin/bash -e
#BSUB -J biokanga_stats<%= @run_name %>              # LSF job name
#BSUB -o biokanga_stats<%= @run_name %>.%J.out       # Name of the job output file
#BSUB -o biokanga_stats<%= @run_name %>.%J.error     # Name of the job error file
