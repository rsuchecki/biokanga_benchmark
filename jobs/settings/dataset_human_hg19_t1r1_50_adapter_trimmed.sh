...
# Dataset name
DATASET="dataset_human_hg19_RefSeq_t1r1-trimmed-50adapter"
...
READS_FILE="trimmed.50.adapter.simulated_reads_HG19t1r1.fa"
READS_FILE_CHANGE_ID="trimmed.50.adapter.simulated_reads_HG19t1r1.changeID.fa"
READ_1_FILE="trimmed.50.adapter.simulated_reads_HG19t1r1.forward.fa"
READ_1_FILE_CHANGE_ID="trimmed.50.adapter.simulated_reads_HG19t1r1.forward.changeID.fa"
READ_2_FILE="trimmed.50.adapter.simulated_reads_HG19t1r1.reverse.fa"
READ_2_FILE_CHANGE_ID="trimmed.50.adapter.simulated_reads_HG19t1r1.reverse.changeID.fa"
...
# Compare to truth
CIG_FILE="50.adapter.simulated_reads_HG19t1r1.cig"
