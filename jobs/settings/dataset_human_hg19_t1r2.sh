...
# Dataset name
DATASET="dataset_human_hg19_RefSeq_t1r2"
...
# Reads
READS_PATH="/project/itmatlab/aligner_benchmark/dataset/human/dataset_t1r2"
READS_FILE="simulated_reads_HG19t1r2.fa"
READS_FILE_CHANGE_ID="simulated_reads_HG19t1r2.changeID.fa"
READ_1_FILE="simulated_reads_HG19t1r2.forward.fa"
READ_1_FILE_CHANGE_ID="simulated_reads_HG19t1r2.forward.changeID.fa"
READ_2_FILE="simulated_reads_HG19t1r2.reverse.fa"
READ_2_FILE_CHANGE_ID="simulated_reads_HG19t1r2.reverse.changeID.fa"
...
# Compare to truth
CIG_FILE="simulated_reads_HG19t1r2.cig"
TRANSCRIPTS="simulated_reads_transcripts_HG19t1r2.txt"
JUNCTIONS_CROSSED="simulated_reads_junctions-crossed_HG19t1r2.txt"
