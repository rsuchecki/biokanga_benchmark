...
# Dataset name
DATASET="dataset_human_hg19_RefSeq_t1r1"
...
READS_FILE="simulated_reads_HG19t1r1.fa"
READS_FILE_CHANGE_ID="simulated_reads_HG19t1r1.changeID.fa"
READ_1_FILE="simulated_reads_HG19t1r1.forward.fa"
READ_1_FILE_CHANGE_ID="simulated_reads_HG19t1r1.forward.changeID.fa"
READ_2_FILE="simulated_reads_HG19t1r1.reverse.fa"
READ_2_FILE_CHANGE_ID="simulated_reads_HG19t1r1.reverse.changeID.fa"
