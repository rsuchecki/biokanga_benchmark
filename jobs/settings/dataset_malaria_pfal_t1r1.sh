...
# Dataset name
DATASET="dataset_malaria_pfal_t1r1"
...
# Reads
READS_PATH="/project/itmatlab/aligner_benchmark/dataset/malaria/dataset_t1r1"
READS_FILE="simulated_reads_PFALt1r1.fa"
READS_FILE_CHANGE_ID="simulated_reads_PFALt1r1.changeID.fa"
READ_1_FILE="simulated_reads_PFALt1r1.forward.fa"
READ_1_FILE_CHANGE_ID="simulated_reads_PFALt1r1.forward.changeID.fa"
READ_2_FILE="simulated_reads_PFALt1r1.reverse.fa"
READ_2_FILE_CHANGE_ID="simulated_reads_PFALt1r1.reverse.changeID.fa"
...
# Compare to truth
CIG_FILE="simulated_reads_PFALt1r1.cig"
TRANSCRIPTS="simulated_reads_transcripts_PFALt1r1.txt"
JUNCTIONS_CROSSED="simulated_reads_junctions-crossed_PFALt1r1.txt"
