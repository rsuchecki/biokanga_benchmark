#!/bin/bash
#BSUB -J hisat-index_job            # LSF job name
#BSUB -o hisat-index_job.%J.out     # Name of the job output file
#BSUB -e hisat-index_job.%J.error   # Name of the job error file
...
# build index
$HISAT_PATH/$HISAT_INDEX_CMD $GENOME_PATH/$GENOME_FILE $OUTPUT_INDEX_PATH/$GENOME_NAME
