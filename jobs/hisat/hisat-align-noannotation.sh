#!/bin/bash
#BSUB -J hisat-align-noannotation_job            # LSF job name
#BSUB -o hisat-align-noannotation_job.%J.out     # Name of the job output file
#BSUB -e hisat-align-noannotation_job.%J.error   # Name of the job error file
