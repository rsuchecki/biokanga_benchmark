...
java -Xms4000M -Xmx64000m -XX:+UseConcMarkSweepGC -XX:NewSize=300M -XX:MaxNewSize=300M -jar $LASTVERSION_CONTEXTMAP2_PATH/$LASTVERSION_CONTEXTMAP2_ALIGN_CMD \
	-reads $READS_PATH/1M.$READ_1_FILE_CHANGE_ID,$READS_PATH/1M.$READ_2_FILE_CHANGE_ID \
