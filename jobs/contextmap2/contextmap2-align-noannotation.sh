#!/bin/bash
#BSUB -J contextmap2-align-noannotation_job            # LSF job name
#BSUB -o contextmap2-align-noannotation_job.%J.out     # Name of the job output file 
#BSUB -e contextmap2-align-noannotation_job.%J.error   # Name of the job error file
