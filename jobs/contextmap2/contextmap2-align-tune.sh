...
OUTPUT_ALIGNMENT_PATH=$OUTPUT_ROOT_PATH/$TOOL/alignment/$LIBRARY-tune/tune-$SEED-$SEED_MISMATCHES-$MISMATCHES-$MMDIFF-$MAXHITS-$MINSIZE
...
java -Xms16000M -Xmx128000m -XX:+UseConcMarkSweepGC -XX:NewSize=300M -XX:MaxNewSize=300M -jar $CONTEXTMAP2_PATH/$CONTEXTMAP2_ALIGN_CMD \
	-reads $READS_PATH/2M.$READS_FILE_CHANGE_ID \
	--pairedend \
