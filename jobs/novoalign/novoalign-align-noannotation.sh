#!/bin/bash
#BSUB -J novoalign-align-noannotation_job            # LSF job name
#BSUB -o novoalign-align-noannotation_job.%J.out     # Name of the job output file
#BSUB -e novoalign-align-noannotation_job.%J.error   # Name of the job error file
