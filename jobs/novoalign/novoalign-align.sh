#!/bin/bash
#BSUB -J novoalign-align_job            # LSF job name
#BSUB -o novoalign-align_job.%J.out     # Name of the job output file
#BSUB -e novoalign-align_job.%J.error   # Name of the job error file
