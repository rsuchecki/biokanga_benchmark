#!/bin/bash
#BSUB -J gsnap-align-noannotation_job            # LSF job name
#BSUB -o gsnap-align-noannotation_job.%J.out     # Name of the job output file
#BSUB -e gsnap-align-noannotation_job.%J.error   # Name of the job error file
