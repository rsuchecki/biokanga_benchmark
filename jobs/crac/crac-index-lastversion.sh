...
# load crac library
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$LASTVERSION_CRAC_LIB
...
# build index
$LASTVERSION_CRAC_PATH/$LASTVERSION_CRAC_INDEX_CMD -v index $OUTPUT_INDEX_PATH/$GENOME_NAME $GENOME_PATH/$GENOME_FILE
