#!/bin/bash
#BSUB -J star-align-denovo_job            # LSF job name
#BSUB -o star-align-devono_job.%J.out     # Name of the job output file
#BSUB -e star-align-denovo_job.%J.error   # Name of the job error file
