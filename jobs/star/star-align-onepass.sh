#!/bin/bash
#BSUB -J star-align-onepass_job            # LSF job name
#BSUB -o star-align-onepass_job.%J.out     # Name of the job output file
#BSUB -e star-align-onepass_job.%J.error   # Name of the job error file
...
OUTPUT_ALIGNMENT_PATH=$OUTPUT_ROOT_PATH/$TOOL/alignment/$LIBRARY/onepass
