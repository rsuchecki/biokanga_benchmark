#!/bin/bash
#BSUB -J star-align-noannotation_job            # LSF job name
#BSUB -o star-align-noannotation_job.%J.out     # Name of the job output file
#BSUB -e star-align-noannotation_job.%J.error   # Name of the job error file
