#!/bin/bash
#BSUB -J olego-align-noannotation_job            # LSF job name
#BSUB -o olego-align-noannotation_job.%J.out     # Name of the job output file
#BSUB -e olego-align-noannotation_job.%J.error   # Name of the job error file
