#!/bin/bash
#BSUB -J olego-index_job            # LSF job name
#BSUB -o olego-index_job.%J.out     # Name of the job output file
#BSUB -e olego-index_job.%J.error   # Name of the job error file
...
# build index
$OLEGO_PATH/$OLEGO_INDEX_CMD -p $OUTPUT_INDEX_PATH/$GENOME_NAME $GENOME_PATH/$GENOME_FILE
