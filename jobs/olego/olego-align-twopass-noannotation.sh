#!/bin/bash
#BSUB -J olego-align-twopass-noannotation_job            # LSF job name
#BSUB -o olego-align-twopass-noannotation_job.%J.out     # Name of the job output file
#BSUB -e olego-align-twopass-noannotation_job.%J.error   # Name of the job error file
...
OUTPUT_ALIGNMENT_PATH=$OUTPUT_ROOT_PATH/$TOOL/alignment/$LIBRARY-noannotation/twopass
