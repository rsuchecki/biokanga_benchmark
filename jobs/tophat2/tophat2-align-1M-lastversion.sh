#!/bin/bash
#BSUB -J tophat2-align-1M-lastversion_job            # LSF job name
#BSUB -o tophat2-align-1M-lastversion_job.%J.out     # Name of the job output file
#BSUB -e tophat2-align-1M-lastversion_job.%J.error   # Name of the job error file
...
OUTPUT_ALIGNMENT_PATH=$OUTPUT_ROOT_PATH/$TOOL/alignment/$LIBRARY-1M-lastversion/nocoveragesearch-bowtie2sensitive
mkdir -p $OUTPUT_ALIGNMENT_PATH


# run tophat2
$LASTVERSION_TOPHAT2_PATH/$TOPHAT2_ALIGN_CMD \
