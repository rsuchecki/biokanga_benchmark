#!/bin/bash
#BSUB -J tophat2-index_job            # LSF job name
#BSUB -o tophat2-index_job.%J.out     # Name of the job output file
#BSUB -e tophat2-index_job.%J.error   # Name of the job error file
