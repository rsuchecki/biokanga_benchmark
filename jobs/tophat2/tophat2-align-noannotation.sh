#!/bin/bash
#BSUB -J tophat2-align-noannotation_job            # LSF job name
#BSUB -o tophat2-align-noannotation_job.%J.out     # Name of the job output file
#BSUB -e tophat2-align-noannotation_job.%J.error   # Name of the job error file
...
OUTPUT_ALIGNMENT_PATH=$OUTPUT_ROOT_PATH/$TOOL/alignment/$LIBRARY-noannotation/nocoveragesearch-bowtie2sensitive-noannotation
