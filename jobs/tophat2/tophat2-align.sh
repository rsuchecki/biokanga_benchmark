#!/bin/bash
#BSUB -J tophat2-align_job            # LSF job name
#BSUB -o tophat2-align_job.%J.out     # Name of the job output file
#BSUB -e tophat2-align_job.%J.error   # Name of the job error file
...
OUTPUT_ALIGNMENT_PATH=$OUTPUT_ROOT_PATH/$TOOL/alignment/$LIBRARY/nocoveragesearch-bowtie2sensitive
